...
function ToastItem_Conditional_3_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, ToastItem_Conditional_3_ng_container_1_span_1_Template, 1, 2, "span", 5)(2, ToastItem_Conditional_3_ng_container_1_span_2_Template, 6, 5, "span", 5);
...
function ToastItem_Conditional_3_Conditional_3_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, ToastItem_Conditional_3_Conditional_3_Conditional_2_span_0_Template, 1, 2, "span", 5);
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext(3);
...
function ToastItem_Conditional_3_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵconditionalCreate(2, ToastItem_Conditional_3_Conditional_3_Conditional_2_Template, 1, 1, "span", 2)(3, ToastItem_Conditional_3_Conditional_3_Conditional_3_Template, 1, 4, "TimesIcon", 2);
    ɵɵelementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext(2);
...
function ToastItem_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, ToastItem_Conditional_3_ng_container_1_Template, 8, 10, "ng-container", 4)(2, ToastItem_Conditional_3_ng_container_2_Template, 1, 0, "ng-container", 3);
...
var ToastItem = class _ToastItem extends BaseComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 4,
    vars: 14,
    consts: [["container", ""], ["role", "alert", "aria-live", "assertive", "aria-atomic", "true", 3, "mouseenter", "mouseleave"], [3, "class"], [4, "ngTemplateOutlet", "ngTemplateOutletContext"], [4, "ngIf"], [3, "class", 4, "ngIf"], [3, "ngClass"], ["type", "button", "autofocus", "", 3, "click", "keydown.enter"]],
